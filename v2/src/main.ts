...
Object.assign(window, {
  ...
  // カレンダーコンテキストメニュー
  _calMenuApprove, _calMenuApproveFromRejected, _calMenuAtt,
  _calMenuChangeApprove, _calMenuChangeReject,
  _calMenuDayoffApprove, _calMenuDayoffReject,
  _calMenuDelete, _calMenuEdit, _calMenuHire, _calMenuInterviewInfo,
  _calMenuReject, _calMenuRejectHire, _calMenuRestore, _calMenuRoom,
  _openCalShiftMenu, _selectCancelReason,
  // 予約
  loadReservations, changeResvDate, resetResvForm,
  submitReservation, saveAndSendLine, updateResvRow, cancelResvLine,
  openEditResv, copyResvGuide, copyResvGuideByIdx, sendResvLineNotify,
  _syncResvDatetime, _syncHimeDatetime, checkInterval, checkAutoHonshimei,
  openAdminSalesFromResv, confirmCancelResv,
  // 姫予約
  openHimeModal, openHimeApproveModal, openRoomApproveModal,
  closeHimeModal, closeHimeApproveModal, closeRoomApproveModal,
  confirmHimeApprove, confirmHimeReject,
  submitHimeReservation, submitHimePendingEdit,
  // 売上
  loadSalesReport, submitSalesEntry, calcSalesCoursePrice,
  calcSalesTotal, calcSalesEditTotal, calcGuarantee,
  clearSalesPrefill, setDateRangeMode,
  openAdminSalesFromResv, deleteSalesRow, saveSalesEdit, closeSalesEditModal,
  toggleSEDynOpt, toggleSEExtension, toggleSEOther,
  updateCurrentExtensionPrice, recalcPayroll,
  // 給料
  loadPayroll, changePayrollDay, switchPayrollTab,
  openPayrollPreviewModal, closePayrollPreviewModal,
  copyPayroll, sendPayrollLine, sendPayrollLineFromPreview,
  // 顧客
  loadCustomerMaster, loadCustomerList, editMasterCustomer,
  saveMasterCustomer, saveCustomerEdit, closeCustomerEditModal,
  openCustomerDetail, closeCustomerModal,
  addCustomerModalNG, removeCustomerModalNG,
  selectCEStatus, updateNGLabel,
  deleteMemoById, startEditMemo, cancelEditMemo, submitEditMemo,
  saveCustomerMemo, toggleHistDetail, importCustomersFromSheet,
  // セラピスト・LINE管理
  saveLineUser, deleteLineUser, openLinkLineModal,
  confirmLinkLine, sendReminderOne, sendReminderAll,
  openMenuBackModal, closeMenuBackModal, saveMenuBacks, saveLineEntry,
  selectDiscountMode, hireTherapist, rejectTherapist,
  openTherapistProfileModal, initTherapistProfile, saveTherapistProfile, selectTpCup,
  // シフト
  ...
  openCalAddShift, setCalAddType, confirmCalAddShift,
  openEditShiftModal, confirmEditShift, confirmApproveShift,
  openAttendanceModal, confirmAttendance,
  deleteMyPendingShift, editMyPendingShift,
  updatePendingShift, removePendingItem, restoreShiftToPending,
  switchShiftTab, toggleShiftDeadline, clearShiftDeadline,
  openShiftChangeRequest, closeShiftChangeRequest,
  approveShiftChangeRequest, rejectShiftChangeRequest,
  submitShiftChangeRequest, submitShiftChangeApprove, submitShiftChangeReject,
  ...
  // マスタ管理
  switchMasterTab, openMenuForm, closeMenuForm, saveMenuMaster, deleteMenuMaster,
  editMenuMaster, selectMenuType, openRoomForm, closeRoomForm, saveRoomMaster,
  ...
  openManualForm, closeManualForm, saveManualMaster, deleteManualMaster,
  editManualMaster, filterManualView,
  openPaymentDestForm, closePaymentDestForm, savePaymentDestRow, deletePaymentDestRow,
  loadAllStoreFixedSummary, openFixedCostForm, closeFixedCostForm,
  ...
  openExpenseTplForm, closeExpenseTplForm, saveExpenseTplRow, deleteExpenseTplRow,
  saveStoreExpenseRow, deleteStoreExpenseRow,
  switchSeTab, switchSeFixedSub, onSePresetChange, onSeTemplateChange,
  toggleIvExp, toggleSEDynOpt, toggleSEExtension, toggleSEOther,
  updateBroadcastCount,
  // ルーム・チェックアウト
